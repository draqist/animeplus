    ...
    <>
      <div>
                  ...
                  <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 pb-2 ring-1 ring-white/10">
                    ...
                    <nav className="flex flex-1 flex-col">
                      <ul role="list" className="flex flex-1 flex-col gap-y-7">
                        <li>
                          <div className="text-xs font-semibold leading-6 text-gray-400">Your Chat</div>
        ...
        <div className="sticky top-0 z-40 flex items-center gap-x-6 bg-gray-900 py-4 px-4 shadow-sm sm:px-6 lg:hidden">
          ...
          <div className="flex-1 text-sm font-semibold leading-6 text-white">{name}</div>
        </div>
        ...
        <main className="py-10 lg:pl-72">
          <div className="px-4 sm:px-6 lg:px-8">
            ...
            <section aria-labelledby="notes-title">
              <div className="shadow bg-gray-900 sm:overflow-hidden sm:rounded-lg">
                          ...
                          <div className="flex space-x-3">
                            ...
                            <div>
                              <div className="text-sm">
                                <div className="text-white-900 font-medium">{comment.name}</div>
                              </div>
                              <div className="text-white-700 mt-1 text-sm">
                                <p>{comment.body}</p>
                              </div>
                            </div>
                          </div>
              ...
              <div className="fixed bottom-0 block  w-full  text-indigo-200 focus-within:text-gray-400">
