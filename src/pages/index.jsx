  ...
  return (
    <div className="bg-gray-900">
      ...
      {/* <div className="relative isolate pt-14">
        ...
        <div className=" px-6  lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40 py-24 sm:py-32 lg:pb-40">
        ...
        <div className="absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]">
          <svg
            className="relative left-[calc(50%+3rem)] h-[21.1875rem] max-w-none -translate-x-1/2 sm:left-[calc(50%+36rem)] sm:h-[10.375rem]"
            viewBox="0 0 1155 678"
          >
            <path
